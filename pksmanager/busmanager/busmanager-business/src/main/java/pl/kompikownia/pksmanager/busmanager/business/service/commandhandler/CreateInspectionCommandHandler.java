...
public class CreateInspectionCommandHandler extends CommandHandler<InspectionProjection, CreateInspectionCommand> {
    ...
    public CreateInspectionCommandHandler(InspectionRepository repository, @Lazy CommandExecutor commandExecutor, @Lazy QueryExecutor queryExecutor) {
    ...
    public InspectionProjection handle(CreateInspectionCommand command) {
        CreateInspectionCommand createInspectionCommand = CreateInspectionCommand.builder()
                .id(command.getId())
        ...
        val inspectionProjection = commandExecutor.execute(createInspectionCommand);
